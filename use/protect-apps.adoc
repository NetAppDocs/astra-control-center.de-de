...
IMPORTANT: Wenn Ihre App eine von der unterstützte Storage-Klasse verwendet `ontap-nas-economy` Treiber, Backups führen zu Unterbrechungen und die App ist bis zum Abschluss des Sicherungsvorgangs nicht verfügbar.
