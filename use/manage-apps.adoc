...
TIP: Eine Bezeichnung ist ein Schlüssel-/Wertpaar, das Sie Kubernetes-Objekten zur Identifizierung zuweisen können. Etiketten erleichtern das Sortieren, Organisieren und Auffinden Ihrer Kubernetes-Objekte. Weitere Informationen zu Kubernetes-Labels: https://["In der offiziellen Kubernetes-Dokumentation finden Sie weitere Informationen"^].
...
* Wenn Sie in Astra Control mehrere Namespaces mit Ihren Apps verwenden möchten, link:../use/manage-roles.html#add-a-namespace-constraint-to-a-role["Ändern Sie Benutzerrollen mit Namespace-Einschränkungen"] Nach dem Upgrade auf eine Astra Control Center-Version mit Unterstützung für mehrere Namespace.
...
TIP: Weitere Informationen zu Kubernetes-Labels: https://["In der offiziellen Kubernetes-Dokumentation finden Sie weitere Informationen"^].
