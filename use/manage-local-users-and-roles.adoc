...
[role="lead"]
Sie können Benutzer Ihrer Astra Control Center-Installation über die Astra Control-Benutzeroberfläche hinzufügen, entfernen und bearbeiten. Sie können die Astra Control UI oder verwenden https://["Die Astra Control API"^] Um Benutzer zu managen.
...
* https://["Mit der Astra Control API können Sie die Remote-Authentifizierung und -Benutzer verwalten"^]
...
Sie können Rollen managen, indem Sie Namespace-Einschränkungen hinzufügen und Benutzerrollen auf diese Einschränkungen beschränken. So können Sie den Zugriff auf Ressourcen in Ihrem Unternehmen kontrollieren. Sie können die Astra Control UI oder verwenden https://["Die Astra Control API"^] Rollen managen.
