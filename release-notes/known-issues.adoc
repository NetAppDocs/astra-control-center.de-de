...
Nach dem Upgrade auf Astra Control Center 23.04.2 wird bei einigen Pods möglicherweise ein Fehler in den für relevanten Protokollen angezeigt `task-service-task-purge`:
