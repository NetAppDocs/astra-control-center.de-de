...
* link:../get-started/requirements.html#astra-trident-requirements["Stellen Sie sicher, dass Ihre Umgebung eine von Astra Trident unterstützte Version enthält"^]
* link:../use/enable-acp.html["Aktivieren Sie Astra Control Provisioner für erweiterte Management- und Storage-Bereitstellungsfunktionen"^]
