...
Nachdem Sie das Astra Control Center eingerichtet haben, verwenden Sie die Astra Control UI oder die https://docs.netapp.com/us-en/astra-automation/index.html["Astra Control API"^] So beginnen Sie mit der Verwaltung und dem Schutz von Apps:
