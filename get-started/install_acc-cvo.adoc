...
Astra Trident 22.10 oder höher installiert und konfiguriert und NetApp ONTAP Version 9.8 oder neuer als Storage-Backend [[AWS-Registry]]
...
| Astra Trident (installiert im Rahmen der Kubernetes Cluster Discovery in NetApp BlueXP, ehemals Cloud Manager)  a| 
Astra Trident 22.10 oder höher installiert und konfiguriert und NetApp ONTAP Version 9.8 oder höher als Storage-Backend [[gcp-Registry]]
...
Astra Trident 22.10 oder höher installiert und konfiguriert und NetApp ONTAP Version 9.8 oder höher wird als Storage-Backend verwendet [[Azure-Registry]]
