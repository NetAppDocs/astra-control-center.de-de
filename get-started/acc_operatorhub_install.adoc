...
. [[substep_image_local_Registry_Push]]Schieben Sie die Paketbilder im Astra Control Center-Bildverzeichnis in Ihre lokale Registrierung. Führen Sie die folgenden Ersetzungen durch, bevor Sie den ausführen `push-images` Befehl:
+
...
+
image:openshift_operatorhub.png["Astra Control Center-Installationsseite"]
...
+
image:red_hat_catalog.png["Astra Control Center Übersichtsseite"]
...
. Wählen Sie in der Konsole auf der Registerkarte *Astra Control Center* des Astra Control Center-Bedieners die Option *AstraControlCenter erstellen* aus.image:openshift_acc-operator_details.png["Bedienerseite des Astra Control Center"]
...
NOTE: Weitere Informationen zu CRD-Optionen finden Sie unter https://docs.netapp.com/us-en/astra-control-center/get-started/acc_cluster_cr_options.html["Diesem Abschnitt"^].
