...
[role="lead"]
Wenn Sie Red hat OpenShift verwenden, können Sie Astra Control Center mithilfe des von Red hat zertifizierten Betreibers installieren. Gehen Sie folgendermaßen vor, um Astra Control Center von der zu installieren https://["Red Hat Ecosystem Catalog"^] Oder die Red hat OpenShift-Container-Plattform verwenden.
...
+
... Wählen Sie das NetApp Astra Control Center aus https://["Operator"^].
...
.. Geben Sie die Astra Control Center-Version ein, z. B. 23.04.0-22.
